public class Noarvore {
   ...
   public static void exibirGraficamente(Noarvore tree) {
    ...
    static void exibirGraficamenteRecursivo(Noarvore tree, String prefix, boolean isLeft) {
        if (tree != null) {
            System.out.println(prefix + (isLeft ? "├── " : "└── ") + tree.aluno);
    ...
    public  static void arvoreEsvaziada(Noarvore raiz) {
  	  if(raiz.aluno == null) {
