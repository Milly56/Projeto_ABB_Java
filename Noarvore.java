public class Noarvore {
    ...
    public void imprimiPreOrdem() {
        imprimiPreOrdem(this);
    }

    private void imprimiPreOrdem(Noarvore n) {    	
        if (n != null) {
            System.out.println(n.aluno);
            imprimiPreOrdem(n.esquerda);
            imprimiPreOrdem(n.direita);
        }
    }

    public void imprimiPosOrdem() {
        imprimiPosOrdem(this);
    }

    private void imprimiPosOrdem(Noarvore n) {    	
        if (n != null) {
            imprimiPosOrdem(n.esquerda);
            imprimiPosOrdem(n.direita);
            System.out.println(n.aluno);
        }
    }
